...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        // 'codeVerifiedWithSms' => \App\Http\Middleware\VerifiedCodeCheck::class,
        'verify.with.code' => \App\Http\Middleware\CheckIsVerifiedWithCode::class,
        'is.done.first' => \App\Http\Middleware\IsDoneFirstStepRegister::class,
        'verify_otp' => \App\Http\Middleware\CheckOTPToken::class,
    ];
