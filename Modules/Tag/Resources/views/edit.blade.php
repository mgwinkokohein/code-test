...
@section ('title', __('tag::labels.backend.tag.management') . ' | ' . __('tag::labels.backend.tag.edit'))
...
@section('content')
{{ html()->modelForm($tag, 'PATCH', route('admin.tag.update', $tag->id))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('tag::labels.backend.tag.edit') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
